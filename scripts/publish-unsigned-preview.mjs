...
function releaseNotes(tag) {
  return [
    ...
    '3. Open the DMG and try to open **Agent Host.app**.',
    '4. If macOS blocks it, open **System Settings → Privacy & Security** and choose **Open Anyway**, then confirm the warning.',
    '5. Later launches can use a normal double-click.',
    '',
    'On macOS 15 Sequoia and later, Control-click → Open no longer overrides Gatekeeper for unsigned or unnotarized software.',
    'On macOS 14, Control-click → Open may still work. Do not turn off Gatekeeper.',
    '',
    '## Index',
