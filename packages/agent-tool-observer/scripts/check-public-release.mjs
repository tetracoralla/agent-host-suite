...
const required = ["LICENSE", "NOTICE", "README.md", "SECURITY.md", "package.json"];
...
if (
  ...
  packageJson.repository?.directory !== "packages/agent-tool-observer"
) {
...
console.log("Agent Host Observer package source checks passed");
